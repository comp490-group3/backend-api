...
urlpatterns = [
    ...
    url(r'^business/offer/(?P<pk>[0-9]+)/$', views.OfferDetailView.as_view(), name='offer-detail'),
    url(r'^business/offer/(?P<pk>[0-9]+)/edit/$', views.OfferUpdateView.as_view(), name='offer-update'),
    url(r'^business/offer/(?P<pk>[0-9]+)/delete/$', views.OfferDeleteView.as_view(), name='offer-delete'),
    url(r'^business/(?P<bid>[0-9]+)/offer/add/$', views.OfferCreateView.as_view(), name='offer-add'),
